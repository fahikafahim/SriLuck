...
require_once 'C:\xampp\htdocs\Sriluck_PHP\app\controllers\LoginController.php';
...
<div class="bg-[#F8F5EF] p-8 rounded-lg shadow-md max-w-md w-full min-h-[500px] flex flex-col justify-between">
  ...
  <form method="POST" action="http://localhost/SRILUCK_PHP/app/veiws/admin/admin_dashboard.php" class="flex-1">
